...
2. Download the [latest release executable file](https://github.com/MoEssamKhattab/ZC-GPA-Calculator/releases/download/v1.1-beta/ZC.GPA.Calculator.v1.1-beta.rar).
